  <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2023 <a
              href="https://www.linkedin.com/in/h%E1%BB%93-minh-quang-449a58259/">QuangHM</a>.</strong> All rights
      reserved.
  </footer>
  </div>
  <!-- ./wrapper -->
                  ...
                  <form action="<?php echo url('/admin/profile/update'); ?>" class="form-modal form">
                      ...
                      <div class="form-group col-sm-6">
                          ...
                          <input type="text" class="form-control" name="first_name" id="first_name"
                              value="<?php echo $user->first_name; ?>" placeholder="First Name">
                      </div>
                      <div class="form-group col-sm-6">
                          <label for="last_name">Last Name</label>
                          <input type="text" class="form-control" name="last_name" id="last_name"
                              value="<?php echo $user->last_name; ?>" placeholder="Last Name">
                      </div>
                      ...
                      <div class="form-group col-sm-6">
                          ...
                          <input type="text" name="birthday" placeholder="Birth Day" class="form-control"
                      ...
                      <div class="form-group col-sm-6">
                          ...
                          <select class="form-control" id="gender" name="gender">
                              ...
                              <option value="female" <?php echo $user->gender == 'female' ? 'selected' : false; ?>>
                                  Female
                              </option>
                          </select>
                      </div>
                      ...
                      <?php if ($user->image) { ?>
                      <div class="form-group col-sm-6">
                          <img src="<?php echo assets('images/' . $user->image); ?>" style="width:50px; height: 50px;"
                              alt="" />
                      </div>
                      <?php } ?>
...
$('.delete').on('click', function(e) {
    ...
    if (c === true) {
        $.ajax({
            ...
            success: function(results) {
                if (results.success) {
                    $('#results').removeClass().addClass('alert alert-success').html(results
                        .success);
