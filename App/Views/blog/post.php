...
<ul class="breadcrumb box">
    ...
    <li>
        <a
            href="<?php echo url('/category/' . seo($post->category) . '/' . $post->category_id); ?>"><?php echo $post->category; ?></a>
    </li>
...
<div class="col-sm-9 col-xs-12" id="main-content">
    ...
    <div id="post-page">
        ...
        <!--/ Comments -->
        <!-- Comment Form -->
        <form action="<?php echo url('/post/' . seo($post->title) . '/' . $post->id . '/add-comment'); ?>" method="post"
            id="comment-form" class="box">
            <h3 class="heading">Post Comment</h3>
            <textarea name="comment" id="comment" class="input" placeholder="Post Your Comment" cols="30" rows="10"
